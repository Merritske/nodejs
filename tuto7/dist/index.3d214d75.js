...
_axiosDefault.default.get("https://jsonplaceholder.typicode.com/posts").then((res)=>res.data
).then((data)=>{
    data.forEach((post)=>{
        console.log(post.title);
        _jqueryDefault.default(".list-group").append(`<li class="list-group-item  text-warning bg-secondary">
...
},{"jquery":"hgMhh","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}]},["iKiqL","bB7Pu"], "bB7Pu", "parcelRequire5b6d")
